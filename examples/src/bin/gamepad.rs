...
use usbd_human_interface_device::device::joystick::GamepadReport;
...
fn main() -> ! {
    ...
    let mut joy = UsbHidClassBuilder::new()
        .add_interface(
            usbd_human_interface_device::device::joystick::GamepadInterface::default_config(),
        )
        .build(&usb_bus);
